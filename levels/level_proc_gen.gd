...
func generate_world() -> bool:
	...
	if PlayerManager.desired_seed == "hello":
		...
		'''
		add_easter_tiles(easter_pic)
	elif PlayerManager.desired_seed == "steve":
		var easter_pic: String = '''
		44444444
		44444444
		42222224
		...
		'''
		add_easter_tiles(easter_pic)
	elif PlayerManager.desired_seed == "formless star" or PlayerManager.desired_seed == "formless" or PlayerManager.desired_seed == "star":
		var easter_pic : String = '''
		
		'''
		add_easter_tiles(easter_pic)
