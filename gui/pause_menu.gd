...
@onready var button_save: Button = $ControlPause/VBoxContainer/HBoxContainer/ButtonSave
@onready var button_load: Button = $ControlPause/VBoxContainer/HBoxContainer/ButtonLoad
...
func _ready() -> void:
	...
	button_back.pressed.connect(hide_pause_menu)
	button_settings_back.pressed.connect(_hide_settings_menu)
